...
class BeachLine:
    ...
    def get_arc_above(self, point, l):
        '''
        jest to funkcja znajdująca jaki łuk z drzewa znajduje się nad zadanym punktem
        :param point: punkt nad którym szukamy
        :param l: kierownica dla łuków parabol
        :return: zwracany jest node który zawiera łuk, który znajduje się nad punktem
        '''
        node = self.root
